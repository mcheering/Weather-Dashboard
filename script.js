$("document").ready(function () {
      ...
      function getWeather(cityName) {
            var currentWthrURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=imperial&appid=af1a956362d5886e7e0d1d06e4b5d0a0"
            $.ajax({
                  url: currentWthrURL,
                  method: "GET"
                  ...
                  var uvURL = "https://api.openweathermap.org/data/2.5/uvi?lat=" + response.coord.lat + "&lon=" + response.coord.lon + "&appid=af1a956362d5886e7e0d1d06e4b5d0a0"
                  ...
                  var foreCastUrl = "https://api.openweathermap.org/data/2.5/onecall?lat=" + response.coord.lat + "&lon=" + response.coord.lon + "&units=imperial&cnt=5&appid=af1a956362d5886e7e0d1d06e4b5d0a0"
                  $.ajax({
                        url: foreCastUrl,
                        method: "GET"
